...
import 'package:showroomofficiel/pages/constant/productDetail.dart';

import 'package:flutter_svg/svg.dart';
import 'package:showroomofficiel/pages/constant/colors.dart';
import 'package:showroomofficiel/pages/constant/constant.dart';
import 'package:showroomofficiel/pages/constant/style.dart';
              ...
              itemBuilder: (context, index) => Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    padding: EdgeInsets.symmetric(horizontal: 25), backgroundColor: selectedCategory == index
                        ? AppColors.primary
                        : Colors.grey[200],
                    shape: RoundedRectangleBorder(
